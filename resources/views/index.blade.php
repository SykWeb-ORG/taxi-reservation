...
<body>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="{{ asset('assets/images/logo.svg') }}" alt="Ridex logo">
      </a>
        ...
        <div class="container">
          ...
          <form action="" class="hero-form">
            ...
            <div class="input-wrapper">
              ...
              <input type="text" name="daily-pay" id="input-2" class="input-field" placeholder="Add an amount in $">
            </div>
          ...
          <ul class="featured-car-list">
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-1.jpg') }}" alt="Toyota RAV4 2021" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-2.jpg') }}" alt="BMW 3 Series 2019" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-3.jpg') }}" alt="Volkswagen T-Cross 2020" loading="lazy" width="440"
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-4.jpg') }}" alt="Cadillac Escalade 2020" loading="lazy" width="440"
                    height="300" class="w-100">
                </figure>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-5.jpg') }}" alt="BMW 4 Series GTI 2021" loading="lazy" width="440"
                    height="300" class="w-100">
                </figure>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/images/car-6.jpg') }}" alt="BMW 4 Series 2019" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="{{ asset('assets/images/blog-1.jpg') }}" alt="Opening of new offices of the company" loading="lazy"
                      class="w-100">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="{{ asset('assets/images/blog-2.jpg') }}" alt="What cars are most vulnerable" loading="lazy"
                      class="w-100">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="{{ asset('assets/images/blog-3.jpg') }}" alt="Statistics showed which average age" loading="lazy"
                      class="w-100">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="{{ asset('assets/images/blog-4.jpg') }}" alt="What´s required when renting a car?" loading="lazy"
                      class="w-100">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="{{ asset('assets/images/blog-5.jpg') }}" alt="New rules for handling our cars" loading="lazy"
                      class="w-100">
                  </a>
      ...
      <section class="section contact" id="contact">
        <div class="container">
          ...
          <div class="mainscreen">
            ...
            <div class="card get-start-card">
              <div class="leftside">
                <img src="{{ asset('assets/images/blog-3.jpg') }}" class="product"
                  alt="Card Cars" />
              </div>
              <div class="rightside">
                <form action="">
                  <h3 class="h3 card-title">Payment Information</h3>
                  <p class="card-text">Full Name</p>
                  <input type="text" class="inputbox" name="name" required placeholder="What is your name ?" />
                  <p class="card-text">Phone Number</p>
                  <input type="number" class="inputbox" name="name" required placeholder="Your phone number ?" />
                  <p class="card-text">Card Type</p>
                  <select class="inputbox" name="car_type" id="car_type" required>
                  ...
                  <div class="expcvv">
                    ...
                    <p class="expcvv_text card-text">Begin</p>
                    <input type="date" class="inputbox" name="exp_date" id="exp_date" required />

                    <p class="expcvv_text card-text">End</p>
                    <input type="date" class="inputbox" name="exp_date" id="exp_date" required />
                  </div>
                  <p></p>
